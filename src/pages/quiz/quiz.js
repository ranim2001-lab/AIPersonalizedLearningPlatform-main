    ...
    <div className="question" style={style}>
      ...
      <div className="flexbox options">
        {questionData.options.map((option, index) => {
          // Determine the class based on whether the answer was selected and whether it's correct
          const isCorrect = attempted && index === questionData.answerIndex;
          const isIncorrect = attempted && index !== questionData.answerIndex;
          ...
          return (
            <div className="option" key={index}>
              ...
              {/* Show icons based on correctness */}
              {isCorrect ? (
                <CircleCheck
...
const QuizPage = (props) => {
  ...
  }, [course, topic, subtopic, description, weekNum, subtopicNum]); // Ajout des dépendances manquantes
